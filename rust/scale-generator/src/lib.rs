...
const SHARPS: &[&str] = &["C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "B"];
const FLATS: &[&str] = &["C", "Db", "D", "Eb", "E", "F", "Gb", "G", "Ab", "A", "Bb", "B"];
...
impl Scale {
    pub fn new(tonic: &str, intervals: &str) -> Result<Scale, Error> {
        ...
        let mut pos = chromatic_scale.iter().position(|&n| n.to_uppercase() == tonic.to_uppercase()).unwrap();
